...
var plainToken = "www.tradlinx.com";
...
exports.logOut = function logOut(req){
	...
	req.logout();
	// req.session.destory();console.log('3');
};
...
exports.checkInValidToken = function checkInValidToken(encodedToken) {
	if (encodedToken == Base64.encode(plainToken))
		return true;
	else
		return false;
};
